...
```
/xyz/openbmc_project/Inventory/Item/{EntityType}/{EntityName}
```

**範例**：

```
/xyz/openbmc_project/Inventory/Item/Board/Intel_Front_Panel
/xyz/openbmc_project/inventory/system/board/18_Great_Card
```

Entity 是最上層的 JSON 物件，描述一個硬體元件。它們是配置的容器類型，本身屬性較少。
