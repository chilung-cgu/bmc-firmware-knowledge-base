...
graph TB
    subgraph FWUpdate["fw-update 模組"]
        ...
        AggUpdate["AggregateUpdateManager<br/>聚合更新管理"]
    ...
    Manager --> Inventory
    Manager --> AggUpdate
    AggUpdate --> DeviceUpdater
    DeviceUpdater -->|"PLDM Requester"| FD["Firmware Device (FD)"]
    PackageParser -->|"解析 FW Package"| AggUpdate
    Activation -->|"D-Bus RequestedActivation"| AggUpdate
```
...
private:
    ...
    AggregateUpdateManager updateManager; // 更新管理器
...
| `aggregate_update_manager.cpp/hpp` | 12KB | 聚合更新管理 |
